...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("floripacoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Floripacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    /*
	{"example1.com", "seed.example1.com"},
    {"example2.com", "dnsseed.example2.com"},
	*/
    {NULL, NULL}
};
...
static const char *strTestNetDNSSeed[][2] = {
	/*
	{"example1.com", "testnet-seed.example1.com"},
    {"example2.com", "testnet-dnsseed.example2.com"},
	*/
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Floripacoin is probably already running."), addrBind.ToString().c_str());
        else
...
{
    printf("StopNode()\n");
    GenerateFloripacoins(false, NULL);
    MapPort(false);
