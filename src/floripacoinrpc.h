...
#ifndef _FLORIPACOINRPC_H_
#define _FLORIPACOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Floripacoin is not connected
...
/**
 * Floripacoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value sendalert(const json_spirit::Array& params, bool fHelp); // in rpcnet.cpp
extern json_spirit::Value sendnews(const json_spirit::Array& params, bool fHelp); // in rpcnet.cpp
