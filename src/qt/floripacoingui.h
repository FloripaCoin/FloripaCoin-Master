#ifndef FLORIPACOINGUI_H
#define FLORIPACOINGUI_H
...
/**
  Floripacoin GUI main class. This class represents the main window of the Floripacoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FloripacoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FloripacoinGUI(bool fIsTestnet = false, QWidget *parent = 0);
    ~FloripacoinGUI();
