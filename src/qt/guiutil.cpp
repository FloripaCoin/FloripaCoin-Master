...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Floripacoin.lnk";
}
...
{
    return GetAutostartDir() / "floripacoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Floripacoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  floripacoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Floripacoin-Qt"));
