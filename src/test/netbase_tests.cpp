...
{
    BOOST_CHECK(TestSplitHost("www.floripacoin.co.nz", "www.floripacoin.co.nz", -1));
    BOOST_CHECK(TestSplitHost("[www.floripacoin.co.nz]", "www.floripacoin.co.nz", -1));
    BOOST_CHECK(TestSplitHost("www.floripacoin.co.nz:80", "www.floripacoin.co.nz", 80));
    BOOST_CHECK(TestSplitHost("[www.floripacoin.co.nz]:80", "www.floripacoin.co.nz", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:18124", "127.0.0.1", 18124));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:18124", "127.0.0.1", 18124));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:18124", "::ffff:127.0.0.1", 18124));
    BOOST_CHECK(TestSplitHost("[::]:18124", "::", 18124));
    BOOST_CHECK(TestSplitHost("::18124", "::18124", -1));
    BOOST_CHECK(TestSplitHost(":18124", "", 18124));
    BOOST_CHECK(TestSplitHost("[]:18124", "", 18124));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:18124", "127.0.0.1:18124"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:18124", "[::]:18124"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
