...
unlocked to sign the Floripacoin-Qt.app bundle.
...
allowing somebody to distribute a Floripacoin-Qt.app or floripacoin-qt-setup.exe with a valid
...
that the floripacoin-qt.exe file inside the installer had not been tampered with.
