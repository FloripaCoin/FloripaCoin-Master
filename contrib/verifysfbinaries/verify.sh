...
WORKINGDIR="/tmp/floripacoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/floripacoin/Floripacoin/floripacoin-0.8.99/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/floripacoin/Floripacoin/"
VERSIONPREFIX="floripacoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'floripacoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[floripacoin-]<version>-[rc[0-9]] (example: floripacoin-0.7.1-rc1)"
   echo "wget output:"
